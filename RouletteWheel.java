...
public class RouletteWheel {
	...
	//random number generator, and variable to track sum of input values
	...
	//Returns the index of that individual in O(log n) time.
	public int selectValue()
	{
	 	...
	 	double value = random.nextDouble()*inputSum;
	 ...
	 //Selection runs in O(log n), but removal and reconstruction of the wheel runs in O(n) time, making the method linear.
	 //Returns index of selected and removed individual.
	 public int selectAndRemove()
	 {
	 	int index = selectValue();
	 	remove(index);
	 	return index;
	 }
